...
class EducationalViewController: UIViewController {
    ...
    */
    ...
    @IBAction func CreateGraph(sender: UIButton) {
        let createGraphViewController = self.storyboard?.instantiateViewControllerWithIdentifier("CreateGraphViewController") as! CreateGraphViewController
        
        self.presentViewController(createGraphViewController, animated:true, completion:nil)
